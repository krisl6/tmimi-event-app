...
import { DollarSign, Users, TrendingUp, ArrowRight, Receipt, Share2, Smartphone } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
            ...
            <p className="text-text-muted">
              Generate shareable links to expense reports that anyone can view and verify.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-primary to-purple-600 py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Join thousands of users who trust Tmimi for hassle-free bill splitting.
          </p>
          <Button
            size="lg"
            variant="outline"
